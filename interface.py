...
class Ui_MainWindow(object):
    ...
    def get_content(self):
        content_image, _ = QtWidgets.QFileDialog.getOpenFileName(parent=None,
            caption="Open Image", directory="./content", filter="Image Files (*.png *.jpg *.bmp)")
        self.contentPreview_i.setPixmap(QtGui.QPixmap(content_image))

    def get_style(self):
        style_image, _ = QtWidgets.QFileDialog.getOpenFileName(parent=None,
            caption="Open Image", directory="./styles", filter="Image Files (*.png *.jpg *.bmp)")
        self.stylePreview_i.setPixmap(QtGui.QPixmap(style_image))
